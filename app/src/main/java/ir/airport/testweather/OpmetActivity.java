...
public class OpmetActivity extends AppCompatActivity {
    String uri;
    EditText search;
    Button metar,tafor;
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opmet);
...
Log.d("URL",uri);
    ...
    private class GetItems extends AsyncTask<Void,Void,Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog=new ProgressDialog(OpmetActivity.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            ListAdapter adapter=new SimpleAdapter(OpmetActivity.this,menuItems,R.layout.list_item,new String[]{KEY_Station,KEY_Raw},new int[]{R.id.station,R.id.raw});
