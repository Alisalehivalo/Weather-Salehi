...
public class AviationActivity extends AppCompatActivity {
    ...
    private class GetItems extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog=new ProgressDialog(AviationActivity.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            ListAdapter adapter=new SimpleAdapter(AviationActivity.this,menuItems,R.layout.list_item,new String[]{KEY_Station,KEY_Raw},new int[]{R.id.station,R.id.raw});
